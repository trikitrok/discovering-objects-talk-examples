...
public class SpanishUsersDataValidation : UsersDataValidation
{
    private readonly IdValidator _idValidator;

    public SpanishUsersDataValidation()
    {
    ...
    {
        return !(LuhnTestValidator.Passes(userData.CreditCardNumber()) && _idValidator.IsValid(userData.Id()));
    }
