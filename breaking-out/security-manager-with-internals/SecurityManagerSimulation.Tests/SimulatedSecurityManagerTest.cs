...
public class SimulatedSecurityManagerTest
{
    ...
    public void Setup()
    {
        ...
        _simulatedSecurityManager = new SimulatedSecurityManager(_notifier, _inputReader);
    }
    ...
    public void do_not_save_user_when_password_and_confirm_password_are_not_equals()
    {
        ...
        Notified(message: "The passwords don't match");
    }
    ...
    public void do_not_save_user_when_password_too_short()
    {
        ...
        Notified(message: "Password must be at least 8 characters in length");
    }
    ...
    public void save_user()
    {
        ...
        Notified(message: $"Saving Details for User ({Username}, {FullName}, {encryptedPassword})\n");
    }
